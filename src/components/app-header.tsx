...
export function AppHeader() {
    ...
    return (
        <header className="bg-background/85 backdrop-blur-md sticky top-0 z-50 border-b">
            <div className="w-full ~max-w-7xl mx-auto flex items-center gap-2 h-14 px-6 md:px-8">
